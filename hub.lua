...
hubData["Murder Mystery 2"] = {
    ...
    scripts = {
        ...
        ["Kill All"] = [[
            ...
            game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Kill All", Text = "On - Teleporting + Killing", Duration = 2})
        ]]
    }
}
